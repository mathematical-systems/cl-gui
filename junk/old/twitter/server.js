...
websocket_server.sockets.on('connection', function(socket) {
                                ...
                                socket.on('funcall', function(pkg, fn, args) {
                                              lisp && lisp.write(JSON.stringify({type: 'funcall', pkg: pkg, fn: fn, args: args}) + '\n');
                                              });
        ...
        socket.addListener("data", function(data) {
                               ...
                               if (newlineIndex !== -1) {
                                   ...
                                   case 'event':
                                       ...
                                       break;
                                   case 'funcall':
                                       websocket_server.sockets.emit('funcall', json.fn, json.args);
                                       break;
                                   case 'eval':
